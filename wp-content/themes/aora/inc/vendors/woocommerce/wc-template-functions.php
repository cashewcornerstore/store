...
if ( ! function_exists( 'aora_woocommerce_meta_query' ) ) {
    function aora_woocommerce_meta_query($type){
...
add_filter('woocommerce_add_to_cart_fragments', 'aora_added_cart_fragments');
