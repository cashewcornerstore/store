...
$output['main_color_second'] = array( 
	'background-color' => aora_texttrim('.tbay-search-form .button-group , .post .post-type , .woocommerce #shop-now.has-buy-now .tbay-buy-now,.mobile-btn-cart-click > *#tbay-click-buy-now,.tbay-to-top a i,.tbay-dropdown-cart .group-button p.buttons a.button.view-cart,.cart-dropdown .group-button p.buttons a.button.view-cart'),
